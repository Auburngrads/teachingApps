...
tabPanel(h4("Data Set"), DT::dataTableOutput("lfp1370", height = "565px")),
                
tabPanel(h4('Figure 1.3'),titlePanel("Use this code to reproduce the event plot in Figure 1.3. Input changes and click 'Evaluate'"),
  sidebarLayout( 
    sidebarPanel(
      shinyAce::aceEditor("fig3plot", mode = "r", theme = "github", height = "450px", fontSize = 14,
        ...
        mainPanel(plotOutput("plotfig3", height = "550px"))))),

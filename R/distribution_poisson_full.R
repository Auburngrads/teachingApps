...
distribution_poisson_full <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "distribution_poisson_full", "args.R", package = "teachingApps"))

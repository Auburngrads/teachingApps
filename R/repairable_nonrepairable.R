...
repairable_nonrepairable <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "repairable_nonrepairable", "args.R", package = "teachingApps"))

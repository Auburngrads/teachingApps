...
distribution_lognormal_full <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "distribution_lognormal_full", "args.R", package = "teachingApps"))

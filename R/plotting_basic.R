...
plotting_basic <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "plotting_basic", "args.R", package = "teachingApps"))

#' Visualization app for the logistic distribution
#'
...
`if`(storyteller,
         dir <- dirname(system.file("apps", "distribution_logistic_full", "global.R", package = "teachingApps")),
         dir <- dirname(system.file("apps", "distribution_logistic",      "global.R", package = "teachingApps")))

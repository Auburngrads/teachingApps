...
likelihood_ace2 <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',storyteller = F,...) {

    dir <- dirname(system.file("apps", "likelihood_ace2", "args.R", package = "teachingApps"))

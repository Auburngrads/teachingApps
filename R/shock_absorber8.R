...
shock_absorber8 <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "shock_absorber8", "args.R", package = "teachingApps"))

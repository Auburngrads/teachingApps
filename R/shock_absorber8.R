...
selectInput("PLOT_3", label = h2("Plot Type"),
...
sidebarLayout(
sidebarPanel(width = 3,
selectInput("mleplot", label = h2("Plot Type"),
                       choices = c("CDF Plot",
                                   "Hazard Plot", 
                                   "Compare CDF Plots"), 
                       selected =  "CDF Plot"),

selectInput("mledist", label = h2("Distribution"),
                       choices = c("Weibull",
                                   "Exponential",
                                   "Normal",
                                   "Lognormal",                       
...
selectInput("paramloc", label = h2("Parameter Location"),
                        choices = c("topleft",
                                    "topright",
                                    "bottomleft",
                                    "bottomright"), 

...
plotting_positions <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "plotting_positions", "args.R", package = "teachingApps"))

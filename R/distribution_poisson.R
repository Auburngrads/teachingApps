#' Visualization app for the Poisson distribution
#'
...
function(theme = "flatly", 
         ...
         more.opts = list(NA),...) {
    `if`(storyteller,
         dir <- dirname(system.file("apps", "distribution_poisson_full", "global.R", package = "teachingApps")),
         dir <- dirname(system.file("apps", "distribution_poisson",      "global.R", package = "teachingApps")))

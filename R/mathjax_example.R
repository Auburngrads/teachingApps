...
mathjax_example <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "mathjax_example", "args.R", package = "teachingApps"))

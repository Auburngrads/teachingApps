...
basic_histogram <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "basic_histogram", "args.R", package = "teachingApps"))

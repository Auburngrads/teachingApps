...
distribution_norgets <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "distribution_norgets", "args.R", package = "teachingApps"))

...
soln_numerical <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',storyteller = F,...) {

    dir <- dirname(system.file("apps", "soln_numerical", "args.R", package = "teachingApps"))

...
ace_very_normal <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "ace_very_normal", "args.R", package = "teachingApps"))

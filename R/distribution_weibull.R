...
distribution_weibull <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "distribution_weibull", "args.R", package = "teachingApps"))

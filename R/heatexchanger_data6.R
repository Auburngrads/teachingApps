...
heatexchanger_data6 <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "heatexchanger_data6", "args.R", package = "teachingApps"))

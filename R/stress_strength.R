...
stress_strength <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "stress_strength", "args.R", package = "teachingApps"))

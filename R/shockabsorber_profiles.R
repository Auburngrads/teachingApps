...
shockabsorber_profiles <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "shockabsorber_profiles", "args.R", package = "teachingApps"))

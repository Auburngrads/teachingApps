...
acceptance_mtbf <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "acceptance_mtbf", "args.R", package = "teachingApps"))

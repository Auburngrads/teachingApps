...
diagrammer_network <- function(pub = FALSE, theme = "flatly", rmd = FALSE, width = '100%', height = '800px',...) {

    dir <- dirname(system.file("apps", "diagrammer_network", "args.R", package = "teachingApps"))

...
tabPanel("Plot Type"), 
 ...
 sidebarLayout( 
        sidebarPanel(
            radioButtons("types", 
                         label = "<u>PLOT TYPE</u> <red>type =</red>", 
                         choices = c("'p' (Points)", 
                                     "'l' (Line)", 
                                     "'b' (Both)", 
                                     "'c' (Cutout)", 
...
sidebarLayout(
  sidebarPanel(
    sliderInput("cex", 
                label = "<u>OBJECTS</u><red> cex =</red></b>"),
                min = 0, 
                max = 4, 
                value = 1, 
                step = 0.5, 
    ...
    sliderInput("cex.axis",
                label = "<u>AXES</u><red> cex.axis =</red>",  
                min = 0, 
                max = 4, 
                value = 1, 
                step = 0.5, 
                animate = TRUE),
    sliderInput("cex.lab",
                label = "<u>LABELS</u><red>cex.lab =</red>", 
                min = 0, 
                max = 4, 
                value = 1, 
                step = 0.5, 
    ...
    sliderInput("cex.main", 
                label = "<u>TITLES</u><red> cex.main =</red>", 
                min = 0, 
                max = 4, 
                value = 1, 
                step = 0.5, 
...
tabPanel("Enlarge Objects"), 
  ...
  sidebarLayout(
    sidebarPanel(
      sliderInput("pch",
                  label = "<u>PLOT CHARACTER</u><red> pch =</red>",  
                  min = 0,
                  max = 20,
                  value = 1, 
                  step =   1, 
      ...
      sliderInput("col", 
                  ...
                  animate = TRUE),
      sliderInput("lty", 
                  label = "<u>LINE TYPE</u> <red>lty =</red></b>"),
                  min = 0, 
                  max = 20, 
                  value = 1, 
                  step =   1, 
                  animate = TRUE),
      sliderInput("lwd", 
                  label = "<u>LINE WEIGHT</u> <red>lwd =</red></b>"),
                  min = 0, 
                  max =  3, 
                  value = 1, 
                  step = 0.5, 

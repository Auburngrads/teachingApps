...
- What steps are required to show which distribution is correct?
    ...
    1) Determine which member of the <purple>Exponential</purple> distribution family best fits the data

    2) Determine which member of the <green>Normal</green> distribution family best fits the data

    3) Determine which member of the <red>Lognormal</red> distribution family best fits the data

    4) Determine which member of the <blue>Weibull</blue> distribution family best fits the data
...
- The joint probability/likelihood of observing $(4.2564,0.5319)$ (assuming the <purple>exponential</purple> distribution is correct) would be expressed as

<small>
$$
\begin{aligned}
\mathscr{L}(\underline{\theta}=\theta|\underline{t}=t_1,t_2)&=\prod_{i=1}^2 f(t_i|\theta)\\\\
&=\left(\frac{1}{\theta}\right)\exp\left[-\frac{4.2564}{\theta}\right]\times \left(\frac{1}{\theta}\right)\exp\left[-\frac{0.5319}{\theta}\right]
\end{aligned}
$$
</small>
